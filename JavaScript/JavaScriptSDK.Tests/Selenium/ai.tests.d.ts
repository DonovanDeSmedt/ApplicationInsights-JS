...
declare class PollingAssert {
   ...
   */
  static createPollingAssert(
    assertionFunctionReturnsBoolean: () => boolean,
...
declare module Microsoft.ApplicationInsights {
  ...
  class _InternalLogging {
     ...
     */
    static throwInternal(
      severity: LoggingSeverity,
      msgId: _InternalMessageId,
      msg: string,
      properties?: Object,
      isUserAct?: boolean
    ): void;
