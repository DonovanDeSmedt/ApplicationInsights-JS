...
module Microsoft.ApplicationInsights {
  ...
  export class AppInsights implements IAppInsightsInternal, IAppInsights {
    ...
    constructor(config: IConfig) {
      ...
      var configGetters: ApplicationInsights.ITelemetryConfig = {
        ...
        enableSessionStorageBuffer: () => {
          ...
          return (
            (this.config.isBeaconApiDisabled || !Util.IsBeaconApiSupported()) && this.config.enableSessionStorageBuffer
          );
        },
      ...
      this._pageViewManager = new Microsoft.ApplicationInsights.Telemetry.PageViewManager(
        this,
      ...
      this._eventTracking.action = (
        ...
        var data = new ApplicationInsights.Telemetry.Common.Data<ApplicationInsights.Telemetry.Event>(
          Telemetry.Event.dataType,
          event
        );
    ...
    public sendPageViewInternal(
      ...
      var data = new ApplicationInsights.Telemetry.Common.Data<ApplicationInsights.Telemetry.PageView>(
        Telemetry.PageView.dataType,
        pageView
      );
    ...
    public sendPageViewPerformanceInternal(pageViewPerformance: ApplicationInsights.Telemetry.PageViewPerformance) {
      ...
      var pageViewPerformanceEnvelope = new Telemetry.Common.Envelope(
        pageViewPerformanceData,
        Telemetry.PageViewPerformance.envelopeType
      );
     ...
     */
    public setCustomOperationId(operationId: string) {
      try {
        this.context.operation.setCustomId(operationId);
      } catch (e) {
        _InternalLogging.throwInternal(
          LoggingSeverity.WARNING,
          _InternalMessageId.OperationIdInvalid,
          'override operation id failed, fallback to default operation id: ' + Util.getExceptionName(e),
          { exception: Util.dump(e) }
        );
      }
    }
    ...
    public resetCustomOperationId() {
      try {
        ...
        _InternalLogging.throwInternal(
          LoggingSeverity.WARNING,
          _InternalMessageId.OperationIdInvalid,
          'reset custom operation id failed, fallback to default operation id: ' + Util.getExceptionName(e),
          { exception: Util.dump(e) }
        );
      }
    }
    ...
    public trackDependency(
      ...
      if (this.config.maxAjaxCallsPerView === -1 || this._trackAjaxAttempts < this.config.maxAjaxCallsPerView) {
        ...
        var dependencyData = new ApplicationInsights.Telemetry.Common.Data<
          ApplicationInsights.Telemetry.RemoteDependencyData
        >(Telemetry.RemoteDependencyData.dataType, dependency);
        var envelope = new Telemetry.Common.Envelope(
          dependencyData,
          ApplicationInsights.Telemetry.RemoteDependencyData.envelopeType
        );
        this.context.track(envelope);
    ...
    public trackException(
      ...
      try {
        ...
        var data = new ApplicationInsights.Telemetry.Common.Data<ApplicationInsights.Telemetry.Exception>(
          Telemetry.Exception.dataType,
          exceptionTelemetry
        );
    ...
    public trackMetric(
      ...
      try {
        ...
        var data = new ApplicationInsights.Telemetry.Common.Data<ApplicationInsights.Telemetry.Metric>(
          Telemetry.Metric.dataType,
          telemetry
        );
    ...
    public trackTrace(message: string, properties?: Object, severityLevel?: AI.SeverityLevel) {
      try {
        ...
        var data = new ApplicationInsights.Telemetry.Common.Data<ApplicationInsights.Telemetry.Trace>(
          Telemetry.Trace.dataType,
          telemetry
        );
      ...
      try {
        ...
        _InternalLogging.throwInternal(
          ...
          '_onerror threw exception while logging error, error will not be collected: ' +
            Util.getExceptionName(exception),
  ...
  class Timing {
    ...
    public start(name: string) {
      if (typeof this._events[name] !== 'undefined') {
        _InternalLogging.throwInternal(
          LoggingSeverity.WARNING,
          _InternalMessageId.StartCalledMoreThanOnce,
    ...
    public stop(name: string, url: string, properties?: Object, measurements?: Object) {
      ...
      if (isNaN(start)) {
        _InternalLogging.throwInternal(
          LoggingSeverity.WARNING,
          _InternalMessageId.StopCalledWithoutStart,
